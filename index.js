...
message.channel.send(`<@${message.author.id}> Aleyküm Selam, Hoşgeldiniz Allah’ın Rahmeti Ve Bereketi Üzerinizde Olsun İnşallah `)
}
}
})
...
.setTitle("AstralCode - Yardım Menüsü!")
